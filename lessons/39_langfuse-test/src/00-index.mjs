/**
 * 文章主线第二步：给 DeepAgents 挂上 Langfuse CallbackHandler，观察一次完整 trace。
 * OpenTelemetry 必须在 Agent 和模型相关模块之前启动；运行需要模型 API 与 Langfuse Key。
 */
import "./_shared/instrumentation.mjs";

import { CallbackHandler } from "@langfuse/langchain";
import { createAgent, extractReply } from "./_shared/agent.mjs";
import { shutdownTracing } from "./_shared/instrumentation.mjs";

...
当前 `18_nest+langchain` 是 Nest 学习线的第二个学习阶段。本阶段的重点是把前面已经学过的 LangChain/LCEL 能力放进 Nest 后端服务，理解 Module、Controller、Service、Provider、普通接口和 SSE 流式接口如何承接模型调用。
...
```powershell
Test-Path .\lessons\18_nest+langchain\hello-nest-langchain\REVIEW_NOTES.md
Test-Path .\lessons\18_nest+langchain\hello-nest-langchain\LESSON.md
Get-Content -Encoding utf8 .\lessons\18_nest+langchain\hello-nest-langchain\README.md
Get-Content -Encoding utf8 .\lessons\18_nest+langchain\hello-nest-langchain\REVIEW_NOTES.md
Get-Content -Encoding utf8 .\SUMMARY_RULES.md
git diff --check -- SUMMARY_RULES.md lessons/18_nest+langchain/hello-nest-langchain/README.md lessons/18_nest+langchain/hello-nest-langchain/REVIEW_NOTES.md lessons/18_nest+langchain/hello-nest-langchain/LESSON.md
```

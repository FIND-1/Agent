...
/**
 * 复习重点：把 ChatModel、web_search、send_mail 注册成 Nest Provider，
 * 让 Agent 只依赖注入后的能力。相较纯文本 Agent，本模块新增可被 UI 识别的工具调用。
 */
@Module({

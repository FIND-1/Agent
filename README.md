...
| MCP server and LangChain client        | Experimental | `lessons/01_tool-test/src/04-mcp`                                                         | Uses a local stdio MCP server; the LangChain client also requires a model configuration.                                            |
